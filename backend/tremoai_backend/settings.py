...
# ML/DL Inference Configuration (Feature 008; Feature 051 migration)
# Classical ML models now live directly in backend/ml_models/ (Feature 051 removed the
# legacy ml_models/models/ subdirectory). The single supported model is lgbm_tremor_model.pkl.
ML_MODELS_DIR = BASE_DIR / 'ml_models'
DL_MODELS_DIR = BASE_DIR / 'dl_models' / 'models'

# Default model for inference when not specified in request
# Options: 'lgbm' (LightGBM 3-class tremor classifier), 'lstm', 'cnn_1d'
DEFAULT_INFERENCE_MODEL = config('DEFAULT_INFERENCE_MODEL', default='lgbm')
